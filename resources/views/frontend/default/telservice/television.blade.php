        ...
        <div class="row blockContent">
            <div class="col-sm-12 right-seperate">
                <div class="card-game-panel">
                    ...
                    <a href="{{route('frontend.telservice.homephone')}}"><button type="button" class="btn btn-default">Điện thoại cố định</button></a>
                    <a href="{{route('frontend.telservice.television')}}"><button type="button" class="btn btn-primary">Truyền Hình</button></a>


                            <h1 style="font-size: medium">Thanh toán cước truyền hình</h1>

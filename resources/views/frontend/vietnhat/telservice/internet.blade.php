            ...
            <div class="col-sm-12 right-seperate">
                <div class="card-game-panel">
                    ...
                    <ul class="nav nav-tabs">
                        <li><a data-toggle="tab" href="{{route('frontend.telservice.homephone')}}">Điện thoại cố định</a></li>
                        <li class="active"><a data-toggle="tab" href="{{route('frontend.telservice.internet')}}">Cước Internet</a></li>
                        <li><a data-toggle="tab" href="{{route('frontend.telservice.television')}}">Truyền Hình</a></li>
                    </ul>

                            <h1 style="font-size: medium">Thanh toán cước Internet</h1>

                            <br>
                            <form id="mtopup-form" action="{{ route('frontend.Telserivice.post') }}" method="POST" name="formNapnhanh">

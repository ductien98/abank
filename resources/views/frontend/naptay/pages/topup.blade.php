...
@section('content')
        ...
        <div class="row blockContent">
            <div class="col-sm-12 right-seperate">
                <div class="card-game-panel">
                    <h3 class="panel-title">Nạp tiền di động nhanh</h3>
                    ...
                    <input name="phone_number[]" data-row="1" class="inputRow number_phone form-control normal-control"
                           placeholder="Nhập số đt..." required></span>
                                    ...
                                    <div class="form-group col-sm-2">
                                        <div class="row" style="padding-right: 15px">
                                            ...
                                            <select name="amount[]" data-row="1"
                                                    class="inputRow amount form-control normal-control" required>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-sm-2">
                                    ...
                                    <div class="form-group col-sm-2">
                                        <div class="row" style="padding-right: 15px">
                                            <div>Thanh toán:</div>
                                            <div class="fees normal-control" data-row="1">VND</div>
                                        </div>
                                    </div>
    ...
    <div id="dataRow" class="hidden">
        <div class="irow row-group " data-row="{timestamp}">
            ...
            <input name="phone_number[]" data-row="{timestamp}"
...
@section('js-footer')
    ...
    <script>
        $(document).ready(function () {
            $().on('change', '.inputRow.number_phone', function () {

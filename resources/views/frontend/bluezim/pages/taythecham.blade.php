                ...
                <table id="example1" class="table table-bordered table-striped dataTable">
                    ...
                    @foreach( $listHistory as $itemc )
                        <tr>
                            ...
                            <td>{{$itemc->id}}</td>
                            <td>@if($itemc['status'] == 1)<span class="label label-success">Xong</span> @elseif($itemc['status'] == 2) <span class="label label-info">Sai m.giá</span> @elseif($itemc['status'] == 3) <span class="label label-danger">Thẻ lỗi</span> @elseif($itemc['status'] == 4) <span class="label label-default">Bảo trì</span> @else <span class="label label-warning">Chờ</span> @endif</td>
                            <td>{{$itemc->code}}</td>
                            <td>{{$itemc->serial}}</td>
                            <td>{{$itemc->telco}}</td>
